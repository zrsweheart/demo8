...
_e(function (E, $) {
    ...
    DropList.fn.initDOM = function () {
        ...
        $.each(data, function (commandValue, title) {
            ...
            $item = $('<a href="javascript:;" commandValue="' + commandValue + '"></a>');
...
_e(function (E, $) {
     ...
     E.UI.menus = {
        ...
        'default': {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-command"></i></a>',
            selected: '.selected'
        },
        bold: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-bold"></i></a>',
            selected: '.selected'
        },
        underline: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-underline"></i></a>',
            selected: '.selected'
        },
        italic: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-italic"></i></a>',
            selected: '.selected'
        },
        forecolor: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-pencil"></i></a>',
            selected: '.selected'
        },
        bgcolor: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-brush"></i></a>',
            selected: '.selected'
        },
        strikethrough: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-strikethrough"></i></a>',
            selected: '.selected'
        },
        eraser: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-eraser"></i></a>',
            selected: '.selected'
        },
        quote: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-quotes-left"></i></a>',
            selected: '.selected'
        },
        source: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-code"></i></a>',
            selected: '.selected'
        },
        fontfamily: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-font2"></i></a>',
            selected: '.selected'
        },
        fontsize: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-text-height"></i></a>',
            selected: '.selected'
        },
        head: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-header"></i></a>',
            selected: '.selected'
        },
        orderlist: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-list-numbered"></i></a>',
            selected: '.selected'
        },
        unorderlist: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-list-bullet"></i></a>',
            selected: '.selected'
        },
        alignleft: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-align-left"></i></a>',
            selected: '.selected'
        },
        aligncenter: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-align-center"></i></a>',
            selected: '.selected'
        },
        alignright: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-align-right"></i></a>',
            selected: '.selected'
        },
        link: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-link"></i></a>',
            selected: '.selected'
        },
        unlink: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-unlink"></i></a>',
            selected: '.selected'
        },
        table: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-table"></i></a>',
            selected: '.selected'
        },
        emotion: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-happy"></i></a>',
            selected: '.selected'
        },
        img: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-picture"></i></a>',
            selected: '.selected'
        },
        video: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-play"></i></a>',
            selected: '.selected'
        },
        location: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-location"></i></a>',
            selected: '.selected'
        },
        insertcode: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-terminal"></i></a>',
            selected: '.selected'
        },
        undo: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-ccw"></i></a>',
            selected: '.selected'
        },
        redo: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-cw"></i></a>',
            selected: '.selected'
        },
        fullscreen: {
            normal: '<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-enlarge2"></i></a>',
            selected: '<a href="javascript:;" tabindex="-1" class="selected"><i class="wangeditor-menu-img-shrink2"></i></a>'
        }
     };
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        $.each(configEmotions, function (k, val) {
            ...
            var $tab = $('<a href="javascript:;">' + title +' </a>');
            ...
            $.each(imgs, function (k, src) {
                var $command = $('<a href="javascript:;" commandValue="' + src + '"></a>');
                var $img = $('<img>');
                $img.css({
                    width: size + 'px',
                    height: size + 'px'
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        // tab
        var $uploadTab = $('<a href="javascript:;">上传图片</a>');
        var $linkTab = $('<a href="javascript:;">网络图片</a>');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $triangle = $('<div class="tip-triangle"></div>');
        var $delete = $('<a href="javascript:;"><i class="wangeditor-menu-img-trash-o"></i></a>');
        var $zoomSmall = $('<a href="javascript:;"><i class="wangeditor-menu-img-search-minus"></i></a>');
        var $zoomBig = $('<a href="javascript:;"><i class="wangeditor-menu-img-search-plus"></i></a>');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $zoomSmall = $('<a href="javascript:;"><i class="wangeditor-menu-img-search-minus"></i></a>');
        var $zoomBig = $('<a href="javascript:;"><i class="wangeditor-menu-img-search-plus"></i></a>');
        var $floatLeft = $('<a href="javascript:;"><i class="wangeditor-menu-img-align-left"></i></a>');
        var $noFloat = $('<a href="javascript:;"><i class="wangeditor-menu-img-align-justify"></i></a>');
        var $floatRight = $('<a href="javascript:;"><i class="wangeditor-menu-img-align-right"></i></a>');
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var menu = new E.Menu({
            ...
            $domNormal: $('<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-indent-left"></i></a>'),
            $domSelected: $('<a href="javascript:;" tabindex="-1" class="selected"><i class="wangeditor-menu-img-indent-left"></i></a>')
        });
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var menu = new E.Menu({
            ...
            // 正常状态和选中装下的dom对象，样式需要自定义
            $domNormal: $('<a href="javascript:;" tabindex="-1"><i class="wangeditor-menu-img-arrows-v"></i></a>'),
            $domSelected: $('<a href="javascript:;" tabindex="-1" class="selected"><i class="wangeditor-menu-img-arrows-v"></i></a>')
        });
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        // UI
        var $uploadIcon = $('<a href="javascript:;" class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></a>');
        $uploadContent.append($uploadIcon);
